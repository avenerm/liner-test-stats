...
```
The tables and charts below show a breakdown of systems by the number of tests required before the system achieved a passing result. Data from FY23, FY24, and FY25 is broken out by year to highlight trends since the end of the initial pilot study. 
...
kable(
  ...
  caption = "Number of Tests Required to Pass: All Years",
  align = "l"
)
...
```{r max_rr_ts}
fy_starts <- seq(from = date_from_char("7/1/2020"), by = "year", length.out = 6)
